package sena.com.co.fallasviales.formularios;
...
public class FormularioActivity extends AppCompatActivity {
    ...
    private ArrayAdapter<CharSequence> tiposDaños;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tiposDaños = new ArrayAdapter<CharSequence>(this, R.layout.support_simple_spinner_dropdown_item);
        tiposDaños.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public ArrayAdapter<CharSequence> getTiposDaños() {
        return tiposDaños;
    }

    public void setTiposDaños(ArrayAdapter<CharSequence> tiposDaños) {
        this.tiposDaños = tiposDaños;
    }
